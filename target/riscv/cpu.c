...
const RISCVIsaExtData isa_edata_arr[] = {
    ...
    ISA_EXT_DATA_ENTRY(zicfiss, PRIV_VERSION_1_12_0, ext_zicfiss),
    ...
    ISA_EXT_DATA_ENTRY(zibi, PRIV_VERSION_1_12_0, ext_zibi),
...
static void riscv_cpu_init(Object *obj)
{
    ...
    RISCV_CPU(obj)->cfg.ext_sstc = true;
...
static const TypeInfo riscv_cpu_type_infos[] = {
    ...
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N100E,      MXL_RV32, rv32ecu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N100EM,     MXL_RV32, rv32emcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N100EZMMUL, MXL_RV32, rv32ecu_zmmul_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N100,       MXL_RV32, rv32icu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N100M,      MXL_RV32, rv32imcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N100ZMMUL,  MXL_RV32, rv32icu_zmmul_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N200,       MXL_RV32, rv32imcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N200E,      MXL_RV32, rv32emcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N201,       MXL_RV32, rv32iacu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N201E,      MXL_RV32, rv32eacu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N202,       MXL_RV32, rv32icu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N202E,      MXL_RV32, rv32ecu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N203,       MXL_RV32, rv32imacu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N203E,      MXL_RV32, rv32emacu_nuclei_cpu_init),
    ...
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N307,       MXL_RV32, rv32imafcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N307FD,     MXL_RV32, rv32imafdcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N600,       MXL_RV32, rv32imacu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N600F,      MXL_RV32, rv32imafcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N600FD,     MXL_RV32, rv32imafdcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N900,       MXL_RV32, rv32imacu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N900F,      MXL_RV32, rv32imafcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_N900FD,     MXL_RV32, rv32imafdcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_U600,       MXL_RV32, rv32imacu_nuclei_u_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_U600F,      MXL_RV32, rv32imafcu_nuclei_u_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_U600FD,     MXL_RV32, rv32imafdcu_nuclei_u_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_U900,       MXL_RV32, rv32imacu_nuclei_u_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_U900F,      MXL_RV32, rv32imafcu_nuclei_u_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_U900FD,     MXL_RV32, rv32imafdcu_nuclei_u_cpu_init),
    ...
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_NX600,   MXL_RV64,  rv64imacu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_NX600F,  MXL_RV64,  rv64imafcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_NX600FD, MXL_RV64,  rv64imafdcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_NX900,   MXL_RV64,  rv64imacu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_NX900F,  MXL_RV64,  rv64imafcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_NX900FD, MXL_RV64,  rv64imafdcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_NX1000,  MXL_RV64,  rv64imacu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_NX1000F, MXL_RV64,  rv64imafcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_NX1000FD,MXL_RV64,  rv64imafdcu_nuclei_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_UX600,   MXL_RV64,  rv64imacu_nuclei_u_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_UX600F,  MXL_RV64,  rv64imafcu_nuclei_u_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_UX600FD, MXL_RV64,  rv64imafdcu_nuclei_u_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_UX900,   MXL_RV64,  rv64imacu_nuclei_u_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_UX900F,  MXL_RV64,  rv64imafcu_nuclei_u_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_UX900FD, MXL_RV64,  rv64imafdcu_nuclei_u_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_UX1000,  MXL_RV64,  rv64imacu_nuclei_u_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_UX1000F, MXL_RV64,  rv64imafcu_nuclei_u_cpu_init),
    DEFINE_CPU(TYPE_RISCV_CPU_NUCLEI_UX1000FD,MXL_RV64,  rv64imafdcu_nuclei_u_cpu_init),
