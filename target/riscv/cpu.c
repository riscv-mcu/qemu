...
const RISCVIsaExtData isa_edata_arr[] = {
    ...
    ISA_EXT_DATA_ENTRY(xxlcz, PRIV_VERSION_1_12_0, ext_xxlcz),
    ISA_EXT_DATA_ENTRY(xxlczpstinc, PRIV_VERSION_1_12_0, ext_xxlczpstinc),
    ISA_EXT_DATA_ENTRY(xxlczbmrk, PRIV_VERSION_1_12_0, ext_xxlczbmrk),
    ISA_EXT_DATA_ENTRY(xxlczbitop, PRIV_VERSION_1_12_0, ext_xxlczbitop),
    ISA_EXT_DATA_ENTRY(xxlczslet, PRIV_VERSION_1_12_0, ext_xxlczslet),
    ISA_EXT_DATA_ENTRY(xxlczabs, PRIV_VERSION_1_12_0, ext_xxlczabs),
    ISA_EXT_DATA_ENTRY(xxlczmac, PRIV_VERSION_1_12_0, ext_xxlczmac),
    ...
    ISA_EXT_DATA_ENTRY(xxlfbf,    PRIV_VERSION_1_12_0, ext_xxlfbf),
    ISA_EXT_DATA_ENTRY(xxlvfbf,   PRIV_VERSION_1_12_0, ext_xxlvfbf),
...
static void rv32icu_nuclei_cpu_init(Object *obj)
{
    CPURISCVState *env = &RISCV_CPU(obj)->env;
    RISCVCPU *cpu = RISCV_CPU(obj);
...
static void rv32ecu_nuclei_cpu_init(Object *obj)
{
    CPURISCVState *env = &RISCV_CPU(obj)->env;
    RISCVCPU *cpu = RISCV_CPU(obj);
...
static void rv32emcu_nuclei_cpu_init(Object *obj)
{
    CPURISCVState *env = &RISCV_CPU(obj)->env;
    RISCVCPU *cpu = RISCV_CPU(obj);
...
static void rv32icu_zmmul_nuclei_cpu_init(Object *obj)
{
    CPURISCVState *env = &RISCV_CPU(obj)->env;
    RISCVCPU *cpu = RISCV_CPU(obj);
...
static void rv32ecu_zmmul_nuclei_cpu_init(Object *obj)
{
    CPURISCVState *env = &RISCV_CPU(obj)->env;
    RISCVCPU *cpu = RISCV_CPU(obj);
...
const RISCVCPUMultiExtConfig riscv_cpu_extensions[] = {
    ...
    MULTI_EXT_CFG_BOOL("zawrs", ext_zawrs, false),
    ...
    MULTI_EXT_CFG_BOOL("zba", ext_zba, false),
    MULTI_EXT_CFG_BOOL("zbb", ext_zbb, false),
    MULTI_EXT_CFG_BOOL("zbc", ext_zbc, false),
    MULTI_EXT_CFG_BOOL("zbkb", ext_zbkb, false),
    MULTI_EXT_CFG_BOOL("zbkc", ext_zbkc, false),
    MULTI_EXT_CFG_BOOL("zbkx", ext_zbkx, false),
    MULTI_EXT_CFG_BOOL("zbs", ext_zbs, false),
...
const RISCVCPUMultiExtConfig riscv_cpu_vendor_exts[] = {
    ...
    MULTI_EXT_CFG_BOOL("xxlcz", ext_xxlcz, false),
    MULTI_EXT_CFG_BOOL("xxlczpstinc", ext_xxlczpstinc, false),
    MULTI_EXT_CFG_BOOL("xxlczbmrk", ext_xxlczbmrk, false),
    MULTI_EXT_CFG_BOOL("xxlczbitop", ext_xxlczbitop, false),
    MULTI_EXT_CFG_BOOL("xxlczslet", ext_xxlczslet, false),
    MULTI_EXT_CFG_BOOL("xxlczabs", ext_xxlczabs, false),
    MULTI_EXT_CFG_BOOL("xxlczmac", ext_xxlczmac, false),
    ...
    MULTI_EXT_CFG_BOOL("xxlfbf",    ext_xxlfbf,    false),
    MULTI_EXT_CFG_BOOL("xxlvfbf",   ext_xxlvfbf,   false),
...
static const TypeInfo riscv_cpu_type_infos[] = {
    ...
    DEFINE_DYNAMIC_CPU(TYPE_RISCV_CPU_NUCLEI_