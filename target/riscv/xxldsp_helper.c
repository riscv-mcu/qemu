/*
 * RISC-V Xxldsp* Extensions Helpers for QEMU.
 *
...
{
    int16_t *d = vd, *a = va;
    uint8_t shift = extract32((*(target_ulong *)vb), 0, 4);
    if(shift != 0){
        d[i] = a[i] >> shift;
    }else{
        d[i] = a[i];
                             ...
                             void *vb, uint8_t i)
{
    int32_t *d = vd;
    int32_t *a = va, *b = vb;
    d[i + 1] = ((int64_t)a[i + 1] - (int64_t)b[i]) >> 1;
    d[i] = ((int64_t)a[i] + (int64_t)b[i + 1]) >> 1;
}
                             ...
                             void *vb, uint8_t i)
{
    ...
    *d = (uint16_t)satu64(env, saddu32(env, 0, a[H4(i)], b[H4(i)]), 16);
}
                             ...
                             void *vb, uint8_t i)
{
    ...
    *d = (uint16_t)satu64(env, ssubu32(env, 0, a[H4(i)], b[H4(i)]), 16);
}
                             ...
                             void *vb, uint8_t i)
{
    ...
    *d = (uint32_t)saddu32(env, 0, a[H4(i)], b[H4(i)]);
}
                             ...
                             void *vb, uint8_t i)
{
    ...
    *d = (uint32_t)haddu32(a[H4(i)], b[H4(i)]);
}
                            ...
                            void *vb, void *vc, uint8_t i)
{
    ...
    *d += (int64_t)a[H2(i)] * b[H2(i)] + (int64_t)a[H2(i + 1)] * b[H2(i + 1)] + (int64_t)a[H2(i + 2)] * b[H2(i + 2)] + (int64_t)a[H2(i + 3)] * b[H2(i + 3)];
}
                            ...
                            void *vb, void *vc, uint8_t i)
{
    ...
    *d += (int64_t)a[H2(i)] * b[H2(i + 1)] + (int64_t)a[H2(i + 1)] * b[H2(i)] + (int64_t)a[H2(i + 2)] * b[H2(i + 3)] + (int64_t)a[H2(i + 3)] * b[H2(i + 2)];
}
                            ...
                            void *vb, void *vc, uint8_t i)
{
    ...
    *d += (int64_t)a[H2(i + 1)] * b[H2(i + 1)] - (int64_t)a[H2(i)] * b[H2(i)] + (int64_t)a[H2(i + 3)] * b[H2(i + 3)] - (int64_t)a[H2(i + 2)] * b[H2(i + 2)];
}
                            ...
                            void *vb, void *vc, uint8_t i)
{
    ...
    *d += (int64_t)a[H2(i + 1)] * b[H2(i)] - (int64_t)a[H2(i)] * b[H2(i + 1)] + (int64_t)a[H2(i + 3)] * b[H2(i + 2)] - (int64_t)a[H2(i + 2)] * b[H2(i + 3)];
}
...
{
    int32_t *d = vd, *a = va, *b = vb;
    d[i] = (int32_t)(((int64_t)a[i] * b[i] + (int64_t)a[i + 1] * b[i + 1] + 0x80000000LL) >> 32);
}
...
{
    int32_t *d = vd, *a = va, *b = vb;
    d[i] = (int32_t)(((int64_t)a[i + 1] * b[i] - (int64_t)a[i] * b[i + 1] + 0x80000000LL) >> 32);
}
                             ...
                             void *vb, void *vc, uint8_t i)
{
    ...
    d[i] = sadd64(env, 0, (int64_t)a[i] * b[i], c[i]);
}
                             ...
                             void *vb, void *vc, uint8_t i)
{
    ...
    d[i] = sadd64(env, 0, (int64_t)a[i] * b[i + 1], c[i]);
}
                             ...
                             void *vb, void *vc, uint8_t i)
{
    ...
    d[i] = sadd64(env, 0, (int64_t)a[i + 1] * b[i + 1], c[i]);
}
